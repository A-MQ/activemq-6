 ...
 */
public class HornetQTCPTransportConfigurationSchema extends URISchema<List<TransportConfiguration>, String>
{
   private final Set<String> allowableProperties;

   public HornetQTCPTransportConfigurationSchema(Set<String> allowableProperties)
   {
